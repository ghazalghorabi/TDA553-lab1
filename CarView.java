...
public class CarView extends JFrame{// denna är kvar 
    ...
    // The controller member, denna ska vara i controller, där man har olika knappar för olika situationer
    ...
    //vi ska rita knapparna i draw, för varje sorts knapp skapar vi en controller klass och där har vi user input och att vi ritar upp varje knapp i den klassen så till exempel brake för contollerbrake. 
    ...
    private void initComponents(String title) {//should stay :)
        ...
        SpinnerModel spinnerModel = //GasAmount, i en egen controller ? vara i en egen klass, can contoller spinner klass
